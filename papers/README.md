...
| HarnessForge (`chen-2026-harnessforge-joint-harness-and-policy`) | [2606.01779v1](https://arxiv.org/pdf/2606.01779v1) | transport | 3,872,329 bytes; download/hash reverified; interrupted binary upload; expected Git blob returns 404. |
| Co-Evolving Harnesses and Models (`yu-2026-co-evolving-harnesses-and-models`) | [2609.09134v1](https://arxiv.org/pdf/2609.09134v1) | transport | 378,829 bytes; download/hash reverified; not attached to a completed ingestion tree; binary connector read cannot be decoded. |
