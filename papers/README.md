...
| Procedural Graphs (`lu-2026-procedural-graphs-self-evolving-execution`) | [2609.09153v1](https://arxiv.org/pdf/2609.09153v1) | 5,653,711 | transport | Exact 36-page PDF reviewed and hash-verified locally; two bounded Git Data API uploads timed out (55s/120s); expected blob returns 404. [Reviewed paper draft](../agenda/llm-wiki-ops/pending-ingestions/lu-2026-procedural-graphs-self-evolving-execution.paper.md); [complete bundle](../agenda/llm-wiki-ops/pending-ingestions/lu-2026-procedural-graphs-self-evolving-execution.json). |
