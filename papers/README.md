...
This branch contains **20 / 20 admitted exact PDFs**: four seeds, fifteen later additions, and the full-text upgrade of AutoSaddler already cataloged on main. All have source notes, paper wiki pages, and synthesis connections. PDFs are copied unchanged; extracted full-text transcriptions are not committed.
