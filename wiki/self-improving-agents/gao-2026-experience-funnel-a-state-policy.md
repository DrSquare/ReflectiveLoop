...
[[feng-2026-coskill-joint-reinforcement]]; [[fu-2026-self-play-meets-skill-evolution]]; [[ye-2026-meta-context-engineering-via-agentic]]. Synthesis: [[concepts/procedural-self-improvement]] and [[concepts/evaluating-self-improvement]]. Detailed provenance: [source note](../../sources/gao-2026-experience-funnel-a-state-policy.md); [PDF](../../papers/gao-2026-experience-funnel-a-state-policy.pdf).
