...
AutoHarness: improving LLM agents by automatically synthesizing a code harness. 2603.03329v1; submission date 2026-02-10. The unchanged [local PDF](../papers/lou-2026-autoharness-improving-llm-agents-by.pdf) has 21 pages. Citations are 1-based PDF pages. Review covers methods, reported results, and cited limitations, not experiment reproduction or a complete code audit. No author-linked implementation URL was identified in the reviewed paper. Search found multiple unrelated AutoHarness repositories; none is attributed to these authors without evidence.
...
[[xu-2026-adapting-the-interface-not-the]]; [[zhang-2025-darwin-godel-machine-open-ended]]; [[gao-2026-experience-funnel-a-state-policy]]. Synthesis: [[concepts/procedural-self-improvement]] and [[concepts/evaluating-self-improvement]].

## 7. Glossary

Action applicability: whether an action is legal in the current state. Code harness: runtime program surrounding the LLM. Code policy: a program that directly chooses actions. Thompson sampling: stochastic search balancing candidate exploration and refinement.
