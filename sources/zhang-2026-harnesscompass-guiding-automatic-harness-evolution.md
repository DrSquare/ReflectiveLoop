...
HarnessCompass: Guiding Automatic Harness Evolution toward Generalizable and Effective Agent Harnesses. 2608.01918v1; submission date 2026-08-03. The unchanged [local PDF](../papers/zhang-2026-harnesscompass-guiding-automatic-harness-evolution.pdf) has 17 pages. Citations are 1-based PDF pages. Review covers methods, reported results, and cited limitations, not experiment reproduction or a complete code audit. No unambiguous official implementation URL was identified in the reviewed PDF/arXiv metadata; unrelated similarly named repositories are not substituted.
...
[[zhang-2026-self-harness-harnesses-that-improve]]; [[xu-2026-adapting-the-interface-not-the]]; [[park-2026-autosaddler-automatic-harness-optimization-with]]. Synthesis: [[concepts/procedural-self-improvement]] and [[concepts/evaluating-self-improvement]].

## 7. Glossary

Generalization gate: constraints on task-specific edits. Proactive feedback: agent self-report checked against trace evidence. R3: revision, recombination, and refinement of separately evolved tracks.
