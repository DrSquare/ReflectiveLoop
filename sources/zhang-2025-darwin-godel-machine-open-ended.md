...
Darwin Godel Machine: Open-Ended Evolution of Self-Improving Agents. 2505.22954v1; first submitted 2025/05/29. The exact [local PDF](../papers/zhang-2025-darwin-godel-machine-open-ended.pdf) has 64 pages. Citations use 1-based PDF pages. Review covers the main method, cited experiments and limitations; no reproduction was run. [Author-linked project/code](https://github.com/jennyzzt/dgm) is provided for follow-up; implementation behavior was not audited.
...
[[zhang-2026-hyperagents]]; [[lee-2026-meta-harness-end-to-end]]. Synthesis: [[concepts/procedural-self-improvement]] and [[overviews/self-improving-llm-agents]].

## 7. Glossary

Archive: retained executable agent variants. Stepping stone: a candidate enabling a later improvement despite its current score. Empirical self-improvement: selection using observed results rather than formal proof.
